...
const stripePromise = loadStripe('pk_test_51LPN6ISBLeea3bMdcUxqlMhpXg1Q7gALq8ZcRPhbEGlDWqAmkgXjHWSGn4YqWW6Er2Gvok8NjDQYQvlOj4XB5kza00SKAYval6');
function CartPage() {
        ...
        <Container style={{ minHeight: '95vh' }} className="cart-container">
            <Row>
                <Col md={7}>
                    ...
                    {cart.length == 0 ? (
                        <Alert variant="info">Shopping cart is empty.<br /> 
                        Add products to your cart</Alert>
                    ) : 
